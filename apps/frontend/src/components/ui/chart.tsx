...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 responsive text-caption shadow-xl",
        className,
      )}
    >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value != null && (
                        <span className="font-medium leading-none text-[#000000] dark:text-[#ffffff] text-caption tabular-nums">
