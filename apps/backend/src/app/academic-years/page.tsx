...
import { AlertCircle, RefreshCw, CalendarDays, Plus } from "lucide-react";
...
function AcademicYearsPageInner() {
  ...
  const listQuery = useAcademicYearsListQuery(api, canWrite || true);
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <TypographyH1 className={ADMIN_PAGE_TITLE_PRIMARY_CLASS}>
            <CalendarDays className={ADMIN_PAGE_TITLE_ICON_CLASS} aria-hidden />
            Niên khóa
          </TypographyH1>
