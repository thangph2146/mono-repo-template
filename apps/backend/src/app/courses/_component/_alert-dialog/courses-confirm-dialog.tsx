...
import type { CourseConfirmAction } from "../types";

export interface CoursesConfirmDialogProps {
  confirmAction: CourseConfirmAction | null;
...
export function CoursesConfirmDialog({
  confirmAction,
  deleteMutation,
  restoreMutation,
  purgeMutation,
