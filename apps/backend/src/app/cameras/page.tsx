...
function CamerasPageInner() {
  ...
  const listQ = useCamerasListQuery(api, canWrite || true);
  const trashQ = useCamerasTrashQuery({ api: api, trashPage: tP, trashPageSize: tPS, debouncedTrashQ: dQ, enabled: mainTab === "trash" });
