    ...
    <>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <TypographyH1 className={ADMIN_PAGE_TITLE_PRIMARY_CLASS}>
              {editingId ? "Chỉnh sửa hệ đào tạo" : "Tạo hệ đào tạo mới"}
            </TypographyH1>
            <p className={ADMIN_PAGE_SUBTITLE_CLASS}>
              Quản lý các hệ đào tạo trong hệ thống.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button type="submit" form="training-system-form" className="h-10 rounded-lg font-bold" disabled={submitting}>
            {submitting ? "Đang lưu..." : editingId ? "Cập nhật" : "Lưu"}
          </Button>
        </div>
      </div>

      <form id="training-system-form" onSubmit={form.handleSubmit(onSubmit)} className="my-6">
