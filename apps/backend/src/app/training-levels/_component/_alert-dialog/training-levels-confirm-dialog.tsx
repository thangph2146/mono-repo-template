...
import type { TrainingLevelConfirmAction } from "../types";

export interface TrainingLevelsConfirmDialogProps {
  confirmAction: TrainingLevelConfirmAction | null;
...
export function TrainingLevelsConfirmDialog({
  confirmAction,
  deleteMutation,
  restoreMutation,
  purgeMutation,
  ...
  onConfirm,
  contentClassName,
}: TrainingLevelsConfirmDialogProps) {
