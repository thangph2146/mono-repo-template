...
> **Sinh tự động:** `2026-05-19T09:31:09.606Z` từ `snapshot/graph.json` (cạnh `relation: "imports"`).
...
| `mikro-orm` | `entities` | 23 | orm-entities.ts → account.entity.ts; orm-entities.ts → admission-result.entity.ts; orm-entities.ts → category.entity.ts; orm-entities.ts → comment.entity.ts |
...
| `tags` | `entities` | 3 | tags.controller.ts → notification.entity.ts; tags.service.ts → tag.entity.ts; tags.service.ts → post-tag.entity.ts |
...
- **`entities`**: **173** cạnh từ **26** domain — `_root` (27), `mikro-orm` (23), `system` (23), `common` (13), `dashboard` (12), `public` (9), `posts` (7), `groups` (6)
- **`common`**: **50** cạnh từ **23** domain — `posts` (5), `_root` (4), `users` (4), `admission-results` (3), `contact-requests` (3), `roles` (3), `sessions` (3), `students` (3)
- **`config`**: **48** cạnh từ **26** domain — `uploads` (4), `common` (3), `sessions` (3), `admission-results` (2), `auth` (2), `categories` (2), `comments` (2), `contact-requests` (2)
