...
> **Sinh tự động:** `2026-05-19T02:20:03.860Z` từ `../snapshot/graph.json` — giúp AI nắm **quy mô** và **điểm nóng import** mà không mở full graph.
...
| `src/mikro-orm/orm-entities.ts` | 22 |
...
|------|------------------|
| `src/entities/user.entity.ts` | 31 |
| `src/config/constants.ts` | 30 |
| `src/common/api-response.ts` | 23 |
| `src/entities/notification.entity.ts` | 20 |
| `src/entities/base.entity.ts` | 19 |
