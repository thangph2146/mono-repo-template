...
export const STORE_INTRO_COLUMN_CLASS =
...
export const ADMIN_ALERT_DIALOG_CONTENT_CLASS = "rounded-lg sm:max-w-[450px]"

/** Dialog form hẹp (500px). */
export const ADMIN_DIALOG_CONTENT_MD_CLASS = "rounded-lg sm:max-w-[500px]"

/** Dialog form rộng (3xl). */
export const ADMIN_DIALOG_CONTENT_LG_CLASS = "rounded-lg sm:max-w-3xl"

/** Dialog form danh mục. */
export const ADMIN_DIALOG_CONTENT_CATEGORY_CLASS =
