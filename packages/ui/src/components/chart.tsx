...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "responsive grid min-w-32 items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-caption shadow-xl",
        className
      )}
    >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value != null && (
                        <span className="text-caption leading-none font-medium text-[#000000] tabular-nums dark:text-[#ffffff]">
