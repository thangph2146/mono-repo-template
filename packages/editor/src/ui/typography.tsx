...
export const IconSize = ({
  ...
  size?: "small" | "medium" | "large" | "sm" | "md" | "lg" | "xs" | "xl"
...
export const TypographyPSmall = React.forwardRef<
  HTMLParagraphElement,
  React.HTMLAttributes<HTMLParagraphElement>
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("editor-typography-p-small", className)}
    {...props}
  />
))
TypographyPSmall.displayName = "TypographyPSmall"

export const TypographySpanSmallMuted = React.forwardRef<
  HTMLSpanElement,
  React.HTMLAttributes<HTMLSpanElement>
>(({ className, ...props }, ref) => (
  <span
    ref={ref}
    className={cn("editor-typography-span-small-muted", className)}
    {...props}
  />
))
